...
const USER_ACCESS = Object.freeze({
  cesarvapor: Object.freeze({
    profile: "owner",
    views: ["overview", "infrastructure", "github", "thermal", "ebay", "pdf"],
    capabilities: ["minecraft:read", "minecraft:restart", "github:read", "thermal:read", "ebay:read", "ebay:write", "pdf:read"],
  }),
